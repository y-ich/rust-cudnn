...
impl API {
    ...
    pub fn set_pooling_2d_descriptor(
        ...
        unsafe { API::ffi_set_pooling_2d_descriptor(desc, mode, maxpooling_nan_opt, window_height, window_width, vertical_padding, horizontal_padding, vertical_stride, horizontal_stride) }
    }
    ...
    pub fn get_pooling_2d_descriptor(
        ...
        unsafe { API::ffi_get_pooling_2d_descriptor(desc, mode, maxpooling_nan_opt, window_height, window_width, vertical_padding, horizontal_padding, vertical_stride, horizontal_stride) }
    }
