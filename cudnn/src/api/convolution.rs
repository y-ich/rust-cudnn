...
impl API {
    ...
    pub fn set_filter_descriptor(
        ...
        unsafe { API::ffi_set_filter_nd_descriptor(desc, data_type, format, nb_dims, filter_dim_a) }
    }
    ...
    unsafe fn ffi_set_filter_nd_descriptor(
        ...
        match cudnnSetFilterNdDescriptor(desc, data_type, format, nb_dims, filter_dim_a) {
            cudnnStatus_t::CUDNN_STATUS_SUCCESS => Ok(()),
